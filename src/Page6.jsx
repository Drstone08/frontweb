...
import homeimg2 from "./assets/ques6.jpg";
...
function Page6() {
  ...
  const handleSubmit = async () => {
    if (ans2.trim().toUpperCase() === import.meta.env.VITE_QUES6) {
      const now = new Date();
      ...
      try {
        ...
        navigate("/page7", { state: { roll, team, name, score, date: timestamp } });
      } catch (error) {
        ...
        <div className="w-full max-w-5xl p-6 font-mono rounded-lg shadow-md mb-6">
          ...
          <div className="flex items-center justify-center pt-[20px]">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
              <p className="text-slate-50 font-medium">
                Question No. : <span className="font-semibold">{5}</span>
              </p>
              <p className="text-slate-50 font-medium">
